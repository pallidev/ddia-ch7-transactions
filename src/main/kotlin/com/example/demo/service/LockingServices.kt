 ...
 *   책의 "Explicit locking"(Example 7-1) 와 대응.
 * [OptimisticLockService] — 낙관적 락: @Version 컬럼으로 commit 시점에 충돌을 감지.
 *   책의 "Compare-and-set"(p.245) 와 대응. 충돌이 적을 때 성능이 좋다.
 */
@Service
